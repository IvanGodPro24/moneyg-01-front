...
import { OptionSelectProps, OptionType } from "./OptionSelect.types";

const customStyles = <T extends OptionType>(): StylesConfig<T> => ({
...
function OptionSelect<T extends OptionType>({
  name,
  options,
  placeholder,
  onChange,
